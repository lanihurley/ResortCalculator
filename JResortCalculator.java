// interactive program for a resort pages 745 - 748
// Author Lani Hurley
// Date 10/5/2021
...
//implement ItemListener interface for class JResortCalculator application
public class JResortCalculator extends JFrame implements ItemListener
{
	...
	//declaration of JCheckBox objects
	...
	// create JLabels to hold user instructions/info and JTextField for total price
	...
	JLabel optionExplainLabel2 = new JLabel("Please check the options you want.");

// Class constructor for JResortCalculator()
	...
	// create the itemStateChanged() method event
	@Override
